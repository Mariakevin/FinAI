    ...
    <>
      ...
      <section className="relative min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center overflow-hidden w-full">
        ...
        <motion.div 
          ...
          className="text-center max-w-3xl mx-auto px-4 z-10 py-16"
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold bg-gradient-to-r from-teal-600 via-blue-600 to-primary-600 bg-clip-text text-transparent mb-6 tracking-tight">
      ...
      <section className="py-20 bg-gradient-to-r from-teal-600 to-blue-600 text-white w-full">
